...
function print_banner {
    echo '┌───────────────────────────────────────────────────────────────┐'
    echo '│ 🌌 Nebula-K8s in K8s all-in-one is on the way...              │'
    echo '└───────────────────────────────────────────────────────────────┘'
}
...
function install_nebula_operator {
    ...
    helm install --set controllerManager.resources.requests.cpu=1m nebula-operator nebula-operator/nebula-operator --namespace=nebula-operator-system --version="0.8.0" > /dev/null || logger_error "Failed to install helm chart nebula-operator"
...
function print_footer {
    ...
    echo "┌────────────────────────────────────────┐"
    echo "│ 🌌 Nebula-K8s Playground is Up now!    │"
    echo "├────────────────────────────────────────┤"
    echo "│                                        │"
    echo "│ 🎉 Congrats!                           │"
    echo "│    $ cd ~/.nebula-k8s                  │"
    ...
    echo "│    $ ~/.nebula-k8s/bin/console         │"
    echo "│                                        │"
    echo "│    To remove the playground:           │"
    echo "│    $ ~/.nebula-k8s/uninstall.sh        │"
    echo "│                                        │"
    echo "│ 🚀 Have Fun!                           │"
    echo "│                                        │"
    echo "└────────────────────────────────────────┘"
    ...
    echo "├────────────────────────────────────────────────────────────────────────────────┤"
    echo "│~/.nebula-k8s/bin/console -u root -p password --address=127.0.0.1 --port=32669  │"
    echo "└────────────────────────────────────────────────────────────────────────────────┘"
}
...
function print_footer_error {
    ...
    echo "┌──────────────────────────────────┐"
    echo "│ 🌌 Nebula-K8s run into issues 😢 │"
    echo "├──────────────────────────────────┤"
    echo "│                                  │"
...
function main {
    ...
    # logger_info "Preparing Nebula-K8s Uninstall Script..."
